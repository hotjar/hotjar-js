...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n  box-sizing: border-box;\n}\n\nhtml,\nbody {\n  height: 100%;\n  -moz-osx-font-smoothing: grayscale;\n  -webkit-font-smoothing: antialiased;\n}\n\nbody {\n  font-family: 'Open Sans', Helvetica, Arial, sans-serif;\n\n  /* css variables */\n  --color-crimson: #ea4031;\n  --color-kelly: #42ca49;\n  --color-kelly-dark: #3cba43;\n  --color-oxford: #343f4d;\n  --color-oxford-dark: #232a33;\n  --color-text: rgba(255, 255, 255, 0.83);\n\n  font-size: 16px;\n\n  background-color: var(--color-oxford-dark);\n  color: var(--color-text);\n}\n\n.hidden {\n  display: none;\n}\n\nh1,\nh2,\nh3 {\n  font-weight: 600;\n}\n\nh1 {\n  font-size: 42px;\n}\n\nh2 {\n  font-size: 32px;\n}\n\n#github-link {\n  position: absolute;\n  top: 0;\n  right: 0;\n  padding: 16px;\n}\n#github-link img {\n  width: 32px;\n}\n\n#jumbotron {\n  padding: 120px 10vw;\n}\n#jumbotron h1 {\n  text-align: center;\n}\n\n#jumbotron p {\n  margin-top: 20px;\n  font-size: 20px;\n  text-align: center;\n}\n\ncode {\n  font-family: monospace;\n  font-size: 16px;\n  line-height: 1.4;\n}\n\npre {\n  font-family: monospace;\n}\npre.prettyprint {\n  width: 100% !important;\n  margin: 0 !important;\n  padding: 24px !important;\n  border-radius: 4px !important;\n  background: var(--color-oxford);\n  overflow: hidden;\n}\npre.prettyprint code {\n  background: transparent;\n}\n\n#content {\n  position: relative;\n  padding: 3vw;\n  max-width: 1200px;\n  margin: auto;\n}\n\n#content h2 {\n  margin-top: 40px;\n}\n#content h2::before {\n  display: block;\n  height: 1px;\n  width: 100%;\n  margin-bottom: 40px;\n  background: var(--color-oxford);\n  content: '';\n}\n\n#content a {\n  color: var(--color-crimson);\n  text-decoration: none;\n}\n#content a:hover {\n  text-decoration: underline;\n}\n\n#content p {\n  line-height: 1.4;\n  margin-bottom: 16px;\n}\n\n.row {\n  display: flex;\n  align-items: stretch;\n  padding: 20px 0;\n}\n\n.row:last-child {\n  padding-bottom: 0;\n}\n\n.row .left {\n  position: relative;\n  width: 60%;\n  padding-right: 4vw;\n}\n\n.row .right {\n  width: 40%;\n}\n\n.button {\n  display: block;\n  background-color: var(--color-kelly);\n  color: #fff;\n  font-weight: 700;\n  font-size: 14px;\n  border: none;\n  border-radius: 4px;\n  padding: 12px 20px;\n  cursor: pointer;\n  transition: background-color 0.1s ease-in-out;\n}\n\n.button:hover {\n  background-color: var(--color-kelly-dark);\n}\n\n.button:disabled {\n  background-color: var(--color-oxford);\n  color: var(--color-text);\n  cursor: not-allowed;\n}\n\n.alert {\n  margin: 20px auto;\n  padding: 10px 14px;\n  font-size: 16px;\n  border-radius: 2px;\n}\n\n.alert-success {\n  color: var(--color-kelly);\n  box-shadow: 0 0 0 1px var(--color-kelly);\n}\n\n.alert-danger {\n  color: var(--color-crimson);\n  box-shadow: 0 0 0 1px var(--color-crimson);\n}\n\n@media only screen and (max-width: 800px) {\n  #content .row {\n    flex-direction: column;\n  }\n\n  #content .row .left {\n    width: 100%;\n    padding: 0;\n    margin-bottom: 10px;\n  }\n\n  #content .row .right {\n    width: 100%;\n  }\n}\n", "",{"version":3,"sources":["webpack://./demo.css"],"names":[],"mappings":"AAEA;EACE,sBAAsB;AACxB;;AAEA;;EAEE,YAAY;EACZ,kCAAkC;EAClC,mCAAmC;AACrC;;AAEA;EACE,sDAAsD;;EAEtD,kBAAkB;EAClB,wBAAwB;EACxB,sBAAsB;EACtB,2BAA2B;EAC3B,uBAAuB;EACvB,4BAA4B;EAC5B,uCAAuC;;EAEvC,eAAe;;EAEf,0CAA0C;EAC1C,wBAAwB;AAC1B;;AAEA;EACE,aAAa;AACf;;AAEA;;;EAGE,gBAAgB;AAClB;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,kBAAkB;EAClB,MAAM;EACN,QAAQ;EACR,aAAa;AACf;AACA;EACE,WAAW;AACb;;AAEA;EACE,mBAAmB;AACrB;AACA;EACE,kBAAkB;AACpB;;AAEA;EACE,gBAAgB;EAChB,eAAe;EACf,kBAAkB;AACpB;;AAEA;EACE,sBAAsB;EACtB,eAAe;EACf,gBAAgB;AAClB;;AAEA;EACE,sBAAsB;AACxB;AACA;EACE,sBAAsB;EACtB,oBAAoB;EACpB,wBAAwB;EACxB,6BAA6B;EAC7B,+BAA+B;EAC/B,gBAAgB;AAClB;AACA;EACE,uBAAuB;AACzB;;AAEA;EACE,kBAAkB;EAClB,YAAY;EACZ,iBAAiB;EACjB,YAAY;AACd;;AAEA;EACE,gBAAgB;AAClB;AACA;EACE,cAAc;EACd,WAAW;EACX,WAAW;EACX,mBAAmB;EACnB,+BAA+B;EAC/B,WAAW;AACb;;AAEA;EACE,2BAA2B;EAC3B,qBAAqB;AACvB;AACA;EACE,0BAA0B;AAC5B;;AAEA;EACE,gBAAgB;EAChB,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,oBAAoB;EACpB,eAAe;AACjB;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,kBAAkB;EAClB,UAAU;EACV,kBAAkB;AACpB;;AAEA;EACE,UAAU;AACZ;;AAEA;EACE,cAAc;EACd,oCAAoC;EACpC,WAAW;EACX,gBAAgB;EAChB,eAAe;EACf,YAAY;EACZ,kBAAkB;EAClB,kBAAkB;EAClB,eAAe;EACf,6CAA6C;AAC/C;;AAEA;EACE,yCAAyC;AAC3C;;AAEA;EACE,qCAAqC;EACrC,wBAAwB;EACxB,mBAAmB;AACrB;;AAEA;EACE,iBAAiB;EACjB,kBAAkB;EAClB,eAAe;EACf,kBAAkB;AACpB;;AAEA;EACE,yBAAyB;EACzB,wCAAwC;AAC1C;;AAEA;EACE,2BAA2B;EAC3B,0CAA0C;AAC5C;;AAEA;EACE;IACE,sBAAsB;EACxB;;EAEA;IACE,WAAW;IACX,UAAU;IACV,mBAAmB;EACrB;;EAEA;IACE,WAAW;EACb;AACF","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;600&display=swap');\n\n* {\n  box-sizing: border-box;\n}\n\nhtml,\nbody {\n  height: 100%;\n  -moz-osx-font-smoothing: grayscale;\n  -webkit-font-smoothing: antialiased;\n}\n\nbody {\n  font-family: 'Open Sans', Helvetica, Arial, sans-serif;\n\n  /* css variables */\n  --color-crimson: #ea4031;\n  --color-kelly: #42ca49;\n  --color-kelly-dark: #3cba43;\n  --color-oxford: #343f4d;\n  --color-oxford-dark: #232a33;\n  --color-text: rgba(255, 255, 255, 0.83);\n\n  font-size: 16px;\n\n  background-color: var(--color-oxford-dark);\n  color: var(--color-text);\n}\n\n.hidden {\n  display: none;\n}\n\nh1,\nh2,\nh3 {\n  font-weight: 600;\n}\n\nh1 {\n  font-size: 42px;\n}\n\nh2 {\n  font-size: 32px;\n}\n\n#github-link {\n  position: absolute;\n  top: 0;\n  right: 0;\n  padding: 16px;\n}\n#github-link img {\n  width: 32px;\n}\n\n#jumbotron {\n  padding: 120px 10vw;\n}\n#jumbotron h1 {\n  text-align: center;\n}\n\n#jumbotron p {\n  margin-top: 20px;\n  font-size: 20px;\n  text-align: center;\n}\n\ncode {\n  font-family: monospace;\n  font-size: 16px;\n  line-height: 1.4;\n}\n\npre {\n  font-family: monospace;\n}\npre.prettyprint {\n  width: 100% !important;\n  margin: 0 !important;\n  padding: 24px !important;\n  border-radius: 4px !important;\n  background: var(--color-oxford);\n  overflow: hidden;\n}\npre.prettyprint code {\n  background: transparent;\n}\n\n#content {\n  position: relative;\n  padding: 3vw;\n  max-width: 1200px;\n  margin: auto;\n}\n\n#content h2 {\n  margin-top: 40px;\n}\n#content h2::before {\n  display: block;\n  height: 1px;\n  width: 100%;\n  margin-bottom: 40px;\n  background: var(--color-oxford);\n  content: '';\n}\n\n#content a {\n  color: var(--color-crimson);\n  text-decoration: none;\n}\n#content a:hover {\n  text-decoration: underline;\n}\n\n#content p {\n  line-height: 1.4;\n  margin-bottom: 16px;\n}\n\n.row {\n  display: flex;\n  align-items: stretch;\n  padding: 20px 0;\n}\n\n.row:last-child {\n  padding-bottom: 0;\n}\n\n.row .left {\n  position: relative;\n  width: 60%;\n  padding-right: 4vw;\n}\n\n.row .right {\n  width: 40%;\n}\n\n.button {\n  display: block;\n  background-color: var(--color-kelly);\n  color: #fff;\n  font-weight: 700;\n  font-size: 14px;\n  border: none;\n  border-radius: 4px;\n  padding: 12px 20px;\n  cursor: pointer;\n  transition: background-color 0.1s ease-in-out;\n}\n\n.button:hover {\n  background-color: var(--color-kelly-dark);\n}\n\n.button:disabled {\n  background-color: var(--color-oxford);\n  color: var(--color-text);\n  cursor: not-allowed;\n}\n\n.alert {\n  margin: 20px auto;\n  padding: 10px 14px;\n  font-size: 16px;\n  border-radius: 2px;\n}\n\n.alert-success {\n  color: var(--color-kelly);\n  box-shadow: 0 0 0 1px var(--color-kelly);\n}\n\n.alert-danger {\n  color: var(--color-crimson);\n  box-shadow: 0 0 0 1px var(--color-crimson);\n}\n\n@media only screen and (max-width: 800px) {\n  #content .row {\n    flex-direction: column;\n  }\n\n  #content .row .left {\n    width: 100%;\n    padding: 0;\n    margin-bottom: 10px;\n  }\n\n  #content .row .right {\n    width: 100%;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
